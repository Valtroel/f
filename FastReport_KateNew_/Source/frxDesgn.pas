...
{$ENDIF}
  ...
  public
    ...
    {$IFDEF FPC}
    property LockSelectionChanged:Boolean read FLockSelectionChanged;
    {$ENDIF}
  end;
...
begin
  ...
  begin
    Name := {$IFDEF NONWINFPC}'Nimbus Sans L'{$ELSE}'Arial'{$ENDIF};
    Size := 10;
  end;
...
var
  ...
  begin
    ...
    begin
      ...
      MemoFontName := Ini.ReadString(Nm, 'MemoFontName', {$IFDEF NONWINFPC}'Nimbus Sans L'{$ELSE}'Arial'{$ENDIF});
