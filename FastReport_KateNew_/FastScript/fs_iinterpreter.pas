...
{ TfsProcVariable is a local internal procedure/function. Formal parameters
  ...
  public
    ...
    procedure RestoreLocalVariables(StackIndex: Integer; bSkipVarParams: Boolean = False);
...
procedure TfsProcVariable.RestoreLocalVariables(StackIndex: Integer; bSkipVarParams: Boolean);
var
  i: Integer;
  LocalVars: TList;
  StackItem: TfsLocalVariablesHelper;
begin
  ...
  try
    ...
    begin
      ...
      if not (bSkipVarParams and (StackItem.FVariableLink is TfsParamItem) and (TfsParamItem(StackItem.FVariableLink).FIsVarParam)) then
...
begin
  ...
  begin
    ...
    try
      ...
      if (Item is TfsProcVariable) and TfsProcVariable(Item).Executing then
        TfsProcVariable(Item).RestoreLocalVariables(StackIndex, True);
    end;
  end;
