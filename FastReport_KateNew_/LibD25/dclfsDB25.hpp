...
// (DO NOT EDIT: machine generated header) 'dclfsDB25.dpk' rev: 32.00 (Windows)
...
#include <fs_idbctrlsrtti.hpp>	// (fsDB25)
// PRG_EXT: .bpl
// OBJ_EXT: .obj
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSDB25)
using namespace Dclfsdb25;
#endif
#pragma pack(pop)
#pragma option pop
