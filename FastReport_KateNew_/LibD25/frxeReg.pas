...
frxExportImage,frxExportHTML,frxExportHTMLDiv, frxExportODF,frxExportPDFLaz;
{$ENDIF}
...
{$ENDIF}
{$ELSE}
  RegisterComponents('FastReport 5 exports', [TfrxBMPExport, TfrxPNGExport,
  TfrxJPEGExport,TfrxTIFFExport,TfrxHTMLExport,TfrxHTML4DivExport,
  TfrxHTML5DivExport, TfrxODSExport, TfrxODTExport,TfrxPDFExport
  ]);
{$ENDIF}
end;
