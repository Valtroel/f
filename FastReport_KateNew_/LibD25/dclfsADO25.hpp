...
// (DO NOT EDIT: machine generated header) 'dclfsADO25.dpk' rev: 32.00 (Windows)

#ifndef Dclfsado25HPP
#define Dclfsado25HPP
...
namespace Dclfsado25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfsado25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSADO25)
using namespace Dclfsado25;
#endif
#pragma pack(pop)
#pragma option pop
