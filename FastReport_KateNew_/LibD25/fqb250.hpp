...
// (DO NOT EDIT: machine generated header) 'fqb250.dpk' rev: 32.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FQB250)
using namespace Fqb250;
#endif
#pragma pack(pop)
#pragma option pop
