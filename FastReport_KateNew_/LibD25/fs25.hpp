...
// (DO NOT EDIT: machine generated header) 'fs25.dpk' rev: 32.00 (Windows)
...
#include <fs_iconst.hpp>
#include <fs_idialogsrtti.hpp>
#include <fs_idisp.hpp>
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FS25)
using namespace Fs25;
#endif
#pragma pack(pop)
#pragma option pop
