  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Writeln(pdf, '/A <<');
        if FProtection then
          Writeln(pdf, '/URI ' + '(' + CryptStr(AnsiString(Copy(annot.Hyperlink, 2, Length(annot.Hyperlink) - 2)), FEncKey, FProtection, annot.Number) + ')')
        else
      ...
      begin
        if (Obj.Frame.LeftLine.Style <> fsDouble ) then
          ...
          begin
            ...
            if (ftTop in Obj.Frame.Typ) and (ftBottom in Obj.Frame.Typ) then
              DrawFrameLine(Obj.Frame.LeftLine.Color, Obj.Frame.LeftLine.Style,
                            Obj.Frame.LeftLine.Width, iLeft, iTop, iLeft, ifBottom)
            else if ftTop in Obj.Frame.Typ then
              DrawFrameLine(Obj.Frame.LeftLine.Color, Obj.Frame.LeftLine.Style,
                            Obj.Frame.LeftLine.Width, iLeft, iTop, iLeft, ofBottom)
            else if ftBottom in Obj.Frame.Typ then
              DrawFrameLine(Obj.Frame.LeftLine.Color, Obj.Frame.LeftLine.Style,
                            Obj.Frame.LeftLine.Width, iLeft, oTop, iLeft, ifBottom)
            else DrawFrameLine(Obj.Frame.LeftLine.Color, Obj.Frame.LeftLine.Style,
                            Obj.Frame.LeftLine.Width, iLeft, oTop, iLeft, ofBottom);
          end;
      end;
        ...
        if (Obj.Frame.RightLine.Style <> fsDouble ) then
          ...
          begin
            ...
            if (ftTop in Obj.Frame.Typ) and (ftBottom in Obj.Frame.Typ) then
              ...
              DrawFrameLine(Obj.Frame.RightLine.Color, Obj.Frame.RightLine.Style,
                            Obj.Frame.RightLine.Width, ifRight, iTop, ifRight, ofBottom)
            else if ftBottom in Obj.Frame.Typ then
              DrawFrameLine(Obj.Frame.RightLine.Color, Obj.Frame.RightLine.Style,
                            Obj.Frame.RightLine.Width, ifRight, oTop, ifRight, ifBottom)
            else DrawFrameLine(Obj.Frame.RightLine.Color, Obj.Frame.RightLine.Style,
                            Obj.Frame.RightLine.Width, ifRight, oTop, ifRight, ofBottom);
          end;
      end;
      ...
      begin
        if (Obj.Frame.TopLine.Style <> fsDouble) then
          ...
          begin
            ...
            if (ftLeft in Obj.Frame.Typ) and (ftRight in Obj.Frame.Typ) then
              DrawFrameLine(Obj.Frame.TopLine.Color, Obj.Frame.TopLine.Style,
                            Obj.Frame.TopLine.Width, idLeft, iTop, idRight, iTop)
            else if ftLeft in Obj.Frame.Typ then
              DrawFrameLine(Obj.Frame.TopLine.Color, Obj.Frame.TopLine.Style,
                            Obj.Frame.TopLine.Width, idLeft, iTop, odRight, iTop)
            else if ftRight in Obj.Frame.Typ then
              DrawFrameLine(Obj.Frame.TopLine.Color, Obj.Frame.TopLine.Style,
                            Obj.Frame.TopLine.Width, odLeft, iTop, idRight, iTop)
            else DrawFrameLine(Obj.Frame.TopLine.Color, Obj.Frame.TopLine.Style,
                               Obj.Frame.TopLine.Width, odLeft, iTop, odRight, iTop);
          end;
      end;
        ...
        if (Obj.Frame.BottomLine.Style <> fsDouble) then
          ...
          begin
            ...
            if (ftLeft in Obj.Frame.Typ) and (ftRight in Obj.Frame.Typ) then
              ...
              DrawFrameLine(Obj.Frame.BottomLine.Color, Obj.Frame.BottomLine.Style,
                            Obj.Frame.BottomLine.Width, idLeft, ifBottom, odRight, ifBottom)
            else if ftRight in Obj.Frame.Typ then
              DrawFrameLine(Obj.Frame.BottomLine.Color, Obj.Frame.BottomLine.Style,
                            Obj.Frame.BottomLine.Width, odLeft, ifBottom, idRight, ifBottom)
            else DrawFrameLine(Obj.Frame.BottomLine.Color, Obj.Frame.BottomLine.Style,
                               Obj.Frame.BottomLine.Width, odLeft, ifBottom, odRight, ifBottom);
          end;
      end;
    end;
  end;
...
{$IFNDEF OLD_STYLE}
  ...
  begin
    ...
    try
      ...
      if Obj is TfrxPictureView then
      begin
        {$IFDEF WIN64}PictObj := TfrxPictureView(Obj);{$ENDIF} //x64 warning fix
...
begin
  ...
  try
    ...
    begin
      ...
      if Self.GetFontName = 'Arial#20Unicode#20MS' then
        if c = 667 then
