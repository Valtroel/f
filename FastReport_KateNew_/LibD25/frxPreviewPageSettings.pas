...
begin
  ...
  begin
    ...
    if not NeedRebuild then Page.AlignChildren;
{$IFDEF FRVIEWER}
    if NeedRebuild then
      begin
        Report.Preview.Lock;
        for i := 0 to Report.PreviewPages.Count - 1 do
          begin
            Report.PreviewPages.Page[i].Orientation := Page.Orientation;
            Report.PreviewPages.Page[i].PaperWidth := Page.PaperWidth;
            Report.PreviewPages.Page[i].PaperHeight := Page.PaperHeight;
            Report.PreviewPages.Page[i].PaperSize := Page.PaperSize;

            Report.PreviewPages.Page[i].LeftMargin := Page.LeftMargin;
            Report.PreviewPages.Page[i].RightMargin := Page.RightMargin;
            Report.PreviewPages.Page[i].TopMargin := Page.TopMargin;
            Report.PreviewPages.Page[i].BottomMargin := Page.BottomMargin;

            Report.PreviewPages.Page[i].AlignChildren;
