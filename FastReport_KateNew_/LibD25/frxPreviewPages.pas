...
var
  ...
  var
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          try
            Printer.BeginPage;
            DrawPage(Index, {$IFDEF LCLGTK2}Printer.CUPSPrinter.Canvas{$ELSE}Printer.Canvas{$ENDIF}, Printer.DPI.X / 96, Printer.DPI.Y / 96,
              offsX, offsY);
    ...
    begin
      ...
      DrawPage(Index, {$IFDEF LCLGTK2}Printer.CUPSPrinter.Canvas{$ELSE}Printer.Canvas{$ENDIF}, Printer.DPI.X / 96 * ZoomX, Printer.DPI.Y / 96 * ZoomY,
