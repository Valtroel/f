...
// (DO NOT EDIT: machine generated header) 'fsDB25.dpk' rev: 32.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FSDB25)
using namespace Fsdb25;
#endif
#pragma pack(pop)
#pragma option pop
