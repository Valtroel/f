...
// (DO NOT EDIT: machine generated header) 'dclfsTee25.dpk' rev: 32.00 (Windows)

#ifndef Dclfstee25HPP
#define Dclfstee25HPP
...
namespace Dclfstee25
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfstee25 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSTEE25)
using namespace Dclfstee25;
#endif
#pragma pack(pop)
#pragma option pop
