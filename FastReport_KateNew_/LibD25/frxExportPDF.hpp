...
private:
	...
	void __fastcall WritePDFStream(System::Classes::TStream* target, System::Classes::TMemoryStream* source, int id, bool compressed, bool encrypted, bool startingBrackets, bool endingBrackets, bool enableLength2);
	void __fastcall DrawFrameLine(System::Uitypes::TColor Color, Frxclass::TfrxFrameStyle FrameStyle, System::Extended FrameWidth, System::UnicodeString LeftBegin, System::UnicodeString TopBegin, System::UnicodeString LeftEnd, System::UnicodeString TopEnd);
