#pragma once
#ifndef DOP_VED_LIKVID_REPORT_UNIT_H
#define DOP_VED_LIKVID_REPORT_UNIT_H
...
class TDop_Ved_LikvidReportForm
    : public TForm
{
__published:
    ...
    TSmallintField     * FDQuery3YEAR_UCH;
...
private:
public:
    __fastcall TDop_Ved_LikvidReportForm (TComponent * Owner);
};

extern PACKAGE TDop_Ved_LikvidReportForm * Dop_Ved_LikvidReportForm;

#endif  // DOP_VED_LIKVID_REPORT_UNIT_H