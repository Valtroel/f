...
{ // Показать по возрасту
    ...
    for (int i = 16; i <= 60; i++) { // for для начала рассчета
        // Открываем Query в зависимости от выбранного
        q1 -> Close ();
        q1 -> SQL -> Clear ();
        ...
        case 16:
            StringGrid1 -> Cells[i - 15][0] = AnsiString (i) + " и меньше";
            break;
        case 60:
            StringGrid1 -> Cells[i - 15][0] = AnsiString (i) + " и больше";
            break;
        default:
